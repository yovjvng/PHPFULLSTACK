...
// 역순의 문자열
// $str_abcd = "abc";
// echo strrey($str_abcd);

//문자열 자르기
$str_1 = "가나다라마";
// echo mb_substr($str_1, 2, 2)."\n"; 
// echo mb_substr($str_1, 2, -1); // 스타트 파라미터가 음수이면 오른쪽부터 자릅니다.
