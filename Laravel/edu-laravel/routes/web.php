...
// 요청 메소드에 관계 없이 모든 요청에 대한 처리(맨 위에 있으면 먼저 처리되므로 후처리 안됨)
Route::any('/method', function() {
    return 'ANY Method!!';
});

// 특정 메소드 요청에 대한 처리 (GET 또는 POST인 요청에 대해서만 처리하는 라우트)
...
// 커멘드롤 컨트롤러 생성 : php artisan make:controller TaskController --resource 
